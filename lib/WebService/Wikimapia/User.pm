...
$WebService::Wikimapia::User::VERSION = '0.06';

=head1 NAME

WebService::Wikimapia::User - Placeholder for 'user' of L<WebService::Wikimapia>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WebService::Wikimapia::User
...
1; # End of WebService::Wikimapia::User
