package WebService::Wikimapia::UserAgent::Exceptiom;

$WebService::Wikimapia::UserAgent::Exception::VERSION = '0.05';

=head1 NAME

WebService::Wikimapia::UserAgent::Exception - Exception handler for the module L<WebService::Wikimapia::UserAgent>.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WebService::Wikimapia::UserAgent::Exception
...
1; # End of WebService::Wikimapia::UserAgent::Exception
