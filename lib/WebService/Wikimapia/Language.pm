...
$WebService::Wikimapia::Langauge::VERSION = '0.07';

=head1 NAME

WebService::Wikimapia::Language - Placeholder for 'language' of L<WebService::Wikimapia::Street>.
...
has 'lang_id'           => (is => 'ro');
has 'lang_name'         => (is => 'ro');
has 'native_name'       => (is => 'ro');
has 'object_url'        => (is => 'ro');
has 'object_local_slug' => (is => 'ro');
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc WebService::Wikimapia::Language
